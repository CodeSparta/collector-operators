...
def main():
  ...
  print("Downloading OLM package for Community Operators...")
...
# Download Community Channel OLM pcakage file
...
def CreateCatalogImageAndPushToLocalRegistry():
  ...
  cmd_args = "cd / && buildah bud --isolation=chroot --format docker -f {} -t {}".format(content_root_dir, image_url)
